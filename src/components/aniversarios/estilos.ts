...
/* ─────────────────────────── pessoa do dia ─────────────────────────── */
.aniv-hoje{display:flex;flex-direction:column;gap:14px;}
.aniv-pessoa{display:flex;gap:14px;padding:14px;border-radius:15px;
...
.aniv-foto{position:relative;flex:none;width:60px;height:60px;}
.aniv-foto img,.aniv-foto .aniv-iniciais{width:60px;height:60px;border-radius:9999px;
...
.aniv-reacao-chip{display:inline-flex;align-items:center;gap:2px;height:20px;padding:0 5px;
  margin-left:-6px;border-radius:9999px;font-size:.72rem;line-height:1;
...
/* ──────────────────────────── miolo do item ────────────────────────── */
.aniv-corpo{flex:1;min-width:0;display:flex;flex-direction:column;gap:9px;}
.aniv-nome{font-size:.9rem;font-weight:800;color:hsl(var(--foreground));line-height:1.25;}
.aniv-cargo{font-size:.74rem;color:hsl(var(--muted-foreground));line-height:1.35;}
.aniv-parabens{font-size:.74rem;font-weight:700;color:hsl(var(--primary));}

/* ─────────────────────── barra de reações ──────────────────────────── */
.aniv-barra{display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-top:1px;}
.aniv-bt{display:grid;place-items:center;width:32px;height:32px;border-radius:10px;cursor:pointer;
  font-size:1rem;line-height:1;background:hsl(var(--muted) / .5);
...
.aniv-recado-bt{display:inline-flex;align-items:center;gap:6px;margin-left:auto;
  font-size:.74rem;font-weight:700;color:hsl(var(--primary));
...
.aniv-recado{display:flex;gap:7px;font-size:.78rem;line-height:1.45;
...
/* ─────────────────────────── próximos dias ─────────────────────────── */
.aniv-titulo{font-size:.66rem;font-weight:700;text-transform:uppercase;letter-spacing:.14em;
  color:hsl(var(--muted-foreground));margin:16px 0 8px;}
.aniv-hoje + .aniv-titulo{margin-top:20px;}
.aniv-breve{display:flex;flex-direction:column;}
.aniv-breve-item{display:flex;align-items:center;gap:10px;padding:7px 2px;font-size:.8rem;
  border-top:1px solid hsl(var(--border));}
.aniv-breve-item:first-child{border-top:none;}
.aniv-breve-data{flex:none;width:46px;font-weight:800;font-variant-numeric:tabular-nums;
  color:hsl(var(--primary));}
.aniv-breve-nome{flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;
  color:hsl(var(--foreground));}
.aniv-breve-quando{flex:none;font-size:.7rem;color:hsl(var(--muted-foreground));}
