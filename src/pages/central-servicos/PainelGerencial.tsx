...
import {
  Alerta, CAT_CORES, Chart, ChartFaixas, CORES, EvolucaoChart, FiltroFuturo, Kpi, KpiIndice,
  MultiSelectEmpresa, Painel, Vazio, VIZ_OPCOES, btn, evolCor, evolTxt, inp, lbl, nf, pct,
} from "./painel/ui";
