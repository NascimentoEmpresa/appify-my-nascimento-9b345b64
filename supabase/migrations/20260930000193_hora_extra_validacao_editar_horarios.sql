-- =====================================================================
-- Hora Extra — ajuste do ponto durante a validação da conclusão.
-- =====================================================================
...
BEGIN
  ...
  IF v_total <= 0 THEN RAISE EXCEPTION 'Os horários efetivos informados somam %, dentro da jornada de %. Não há hora extra a validar.', public.hora_extra_formatar_minutos(v_trabalhado), public.hora_extra_formatar_minutos(v_jornada); END IF;
...
-- ROLLBACK
-- DROP FUNCTION IF EXISTS public.hora_extra_validar_com_horarios(uuid, jsonb);
